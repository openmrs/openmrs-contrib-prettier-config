...
The package tests install a tarball into a disposable consumer outside this repository. They use npm's local cache, populated by `npm ci`, and cover CommonJS, ESM, JSON-string configuration, nested discovery, local overrides and root ignores. Formatting fixtures cover TypeScript, TSX, SCSS, JSON and Markdown. CI tests Node 20, 22 and 24 with Prettier 3.9.8, plus Prettier 3.0.0 on Node 20.
